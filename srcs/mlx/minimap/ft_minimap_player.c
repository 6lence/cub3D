...
/*   Updated: 2024/01/17 14:09:59 by mescobar         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_init_player_values(t_data *l)
{
	...
	l->player->radius = MINIMAP_RADIUS;
	l->player->x = l->mini->mapxo - ((l->mini->mapxo - l->mini->mapx + 3) / 2);
	l->player->y = l->mini->mapyo - ((l->mini->mapyo - l->mini->mapy + 5) / 2);
